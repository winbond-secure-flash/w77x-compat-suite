...
#define BOARD_BOOTCLOCKRUN_ACMP_CLOCK                 16000000UL     /* Clock consumers of ACMP_clock output : CMP */
#define BOARD_BOOTCLOCKRUN_ADC_CLOCK                  16000000UL     /* Clock consumers of ADC_clock output : LPADC */
#define BOARD_BOOTCLOCKRUN_CLKOUT_CLOCK               0UL            /* Clock consumers of CLKOUT_clock output : N/A */
#define BOARD_BOOTCLOCKRUN_CTIMER0_CLOCK              16000000UL     /* Clock consumers of CTIMER0_clock output : CTIMER0 */
#define BOARD_BOOTCLOCKRUN_CTIMER1_CLOCK              0UL            /* Clock consumers of CTIMER1_clock output : CTIMER1 */
#define BOARD_BOOTCLOCKRUN_CTIMER2_CLOCK              16000000UL     /* Clock consumers of CTIMER2_clock output : CTIMER2 */
...
#define BOARD_BOOTCLOCKRUN_ESPI_CLOCK                 0UL            /* Clock consumers of ESPI_clock output : N/A */
#define BOARD_BOOTCLOCKRUN_FLEXSPI_CLOCK              1000000UL      /* Clock consumers of FLEXSPI_clock output : FLEXSPI */
#define BOARD_BOOTCLOCKRUN_FXCOM0_CLOCK               48000000UL     /* Clock consumers of FXCOM0_clock output : FLEXCOMM0 */
...
#define BOARD_BOOTCLOCKRUN_FXCOM2_CLOCK               48000000UL     /* Clock consumers of FXCOM2_clock output : FLEXCOMM2 */
...
#define BOARD_BOOTCLOCKRUN_TRACE_CLOCK                500210526UL    /* Clock consumers of TRACE_clock output : SWD */
