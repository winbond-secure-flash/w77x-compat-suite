...
- {id: TRACE_clock.outFreq, value: 9504/19 MHz}
...
- {id: SYSCON.ACMP0FCLKSEL.sel, value: SYSCON.sfro}
- {id: SYSCON.ADC0FCLKDIV.scale, value: '1', locked: true}
...
- {id: SYSCON.CT32BIT2FCLKSEL.sel, value: SYSCON.sfro}
- {id: SYSCON.FC0FCLKSEL.sel, value: SYSCON.ffro}
- {id: SYSCON.FC2FCLKSEL.sel, value: SYSCON.ffro}
- {id: SYSCON.FLEXSPIFCLKDIV.scale, value: '48', locked: true}
...
- {id: SYSCON.PFC0DIV.scale, value: '1', locked: true}
...
- {id: SYSCON.PLL0_PFD3_DIV.scale, value: '12', locked: true}
- {id: SYSCON.PLL0_PFD3_MUL.scale, value: '18', locked: true}
...
void BOARD_BootClockRUN(void)
{
    ...
    CLOCK_AttachClk(kSFRO_to_CTIMER2);                 /* Switch CTIMER2 to SFRO */
    CLOCK_AttachClk(kFFRO_to_FLEXCOMM0);                 /* Switch FLEXCOMM0 to FFRO */
    CLOCK_AttachClk(kFFRO_to_FLEXCOMM2);                 /* Switch FLEXCOMM2 to FFRO */
    CLOCK_AttachClk(kSFRO_to_ADC_CLK);                 /* Switch ADC_CLK to SFRO */
    CLOCK_AttachClk(kSFRO_to_ACMP_CLK);                 /* Switch ACMP_CLK to SFRO */

    /* Set up dividers */
    CLOCK_SetClkDiv(kCLOCK_DivAudioPllClk, 15U);         /* Set AUDIOPLLCLKDIV divider to value 15 */
    CLOCK_SetClkDiv(kCLOCK_DivPfc0Clk, 1U);         /* Set PFC0DIV divider to value 1 */
    CLOCK_SetClkDiv(kCLOCK_DivPllFrgClk, 12U);         /* Set FRGPLLCLKDIV divider to value 12 */
    CLOCK_SetClkDiv(kCLOCK_DivAcmpClk, 1U);         /* Set ACMP0FCLKDIV divider to value 1 */
