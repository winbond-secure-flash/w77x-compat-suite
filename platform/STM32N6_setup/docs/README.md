<h2><u>STM32N65780-DK MB1939C platform instructions</u></h1>
<br>
<br>
...
<li> Remove the on board U25 device (see the Yellow circule)</li>
<li> Replace with Winbond device (for example W77T25NW1)</li>
<br>
<div><img src="images/um3300-discovery-kit-with-stm32n657x0-mcu-stmicroelectronics-bottom-side-bootSwitch.png" width="400"></div><br>
<li> Make sure theat the mechanical switch <strong>BOOT1</strong> is set to <strong>H</strong> position (see the red arrows above)</li>
<li> Connect a USB-C cable to the board's STLINK port on one side indicated as a green arrow</li>
</ol>
...
<li>The project uses Firmware Package V1.3.0 .<br>
SW modules that are included</strong>:<br>
  <ol type="a">
    <li>stm32n6_bsp\Application\Startup\              </li>
    <li>stm32n6_bsp\Application\User\                 </li>
    <li>stm32n6_bsp\Drivers\BSP\STM32N6570-DK\        </li>
    <li>stm32n6_bsp\Drivers\CMSIS\Device              </li>
    <li>stm32n6_bsp\Drivers\CMSIS\Include             </li>
    <li>stm32n6_bsp\Drivers\STM32N6xx_HAL_Driver\Inc  </li>
    <li>stm32n6_bsp\Drivers\STM32N6xx_HAL_Driver\Src  </li>
    <li>stm32n6_bsp\FSBL\Inc                          </li>
    <li>stm32n6_bsp\FSBL\Src                          </li>
  </ol></li>
<br>
</ol>
<br>
...
<ol>
  ...
  <li>un-select all but  the STM32N6_setup checkboxes, then, click on the <strong>Finish</strong>
...
<ol>
  ...
  <div><img src="images/um3300-discovery-kit-with-stm32n657x0-mcu-stmicroelectronics-bottom-side.png" width="500"></div><br>

  <div>Example for test pass indication</div>
  <div><img src="images/um3300-discovery-kit-with-stm32n657x0-mcu-stmicroelectronics-bottom-side-pass.jpg" width="200"></div><br>
  
  <div>Example for test fail indication</div>
  <div><img src="images/um3300-discovery-kit-with-stm32n657x0-mcu-stmicroelectronics-bottom-side-fail.jpg" width="200"></div><br>
</li></ol>
