...
void HAL_UART_MspDeInit(UART_HandleTypeDef* huart)
{
  if(huart->Instance==USART1)
  {
    ...
    PE6     ------> USART1_RX
    */
    HAL_GPIO_DeInit(GPIOE, UART1_TX_Pin|UART1_RX_Pin);
...
void HAL_XSPI_MspInit(XSPI_HandleTypeDef* hxspi)
{
  ...
  */
    ...
    PeriphClkInitStruct.ICSelection[RCC_IC4].ClockSelection = RCC_ICCLKSOURCE_PLL4;
    PeriphClkInitStruct.ICSelection[RCC_IC4].ClockDivider = 18;
    if (HAL_RCCEx_PeriphCLKConfig(&PeriphClkInitStruct) != HAL_OK)
    {
      Error_Handler();
    }
