```
# NXP1050 using W77Q25NW logfile  

[MCUXpresso Semihosting Telnet console for 'CompatibilityTests_nxp1050 LinkServer Debug' started on port 56878 @ 127.0.0.1]

Initializing flash device...
deviceID = 0x18
JEDEC manufacturerID = 0xEF, memoryType = 0x8A, capacity = 0x19 (32768 KB)
Read HW_VER using OP1 and OP2 commands
HW_VER = 0x00083412
Detected Target is W77Q25NW
Octal bus mode is not supported
Read SSR register
SSR = 0xF2000060
SSR Read passed
