...
#define FLEXSPI_RX_SAMPLE_CLK (kFLEXSPI_ReadSampleClkLoopbackFromSckPad) //kFLEXSPI_ReadSampleClkLoopbackInternally; //kFLEXSPI_ReadSampleClkLoopbackFromSckPad
