...
/*! @brief Set serial manager write handle size */
    ...
    /*                                           CUSTOM SDK START                                              */
    /*---------------------------------------------------------------------------------------------------------*/
#ifdef WORKAROUND_USB_SERIAL_MANAGER  // To support USB-CDC in exist SDK which have bug - bug is solved in newer SDK - TODO: update SDK
#define SERIAL_MANAGER_WRITE_HANDLE_SIZE (48U)
#define SERIAL_MANAGER_READ_HANDLE_SIZE (48U)
#else
